          ...
          <div className="flex flex-col space-y-12">
            <div className="flex flex-col space-y-6">
              <h1 className="text-5xl text-black font-bold">
                Data Protection Impact Assessment (DPIA) & Privacy by Design and
                Default
              </h1>
            ...
            <div className="flex flex-col space-y-6">
              ...
              <p className="text-[18px] font-semibold text-gray-600">
                DPIAs evaluate the potential impact of data processing
                activities on personal data protection.
              </p>
            </div>
            ...
            <div className="flex flex-col space-y-6 border-b border-dotted border-gray-300/90 pb-4">
              ...
              <div className="flex flex-row gap-6 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-[18px] font-semibold text-gray-600">
                    Complexity of requests, data accuracy, technical
                    limitations, balancing interests.
                  </p>
                </div>
              </div>
            </div>
